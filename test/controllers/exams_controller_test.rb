...
class ExamsControllerTest < ActionController::TestCase
  ...
  test "should create exam" do
    assert_difference('Exam.count') do
      post :create, exam: { content: @exam.content, examday: @exam.examday, objective_id: @exam.objective_id, stem_id: @exam.stem_id }
    end
  ...
  test "should update exam" do
    patch :update, id: @exam, exam: { content: @exam.content, examday: @exam.examday, objective_id: @exam.objective_id, stem_id: @exam.stem_id }
    assert_redirected_to exam_path(assigns(:exam))
  end
